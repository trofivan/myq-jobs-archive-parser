...
export const URL_LATEST_RELEASE =
  'https://github.com/trofivan/myq-jobs-archive-parser/releases/latest';
export const URL_LATEST_PACKAGE_JSON =
  'https://raw.githubusercontent.com/trofivan/myq-jobs-archive-parser/master/package.json';
